...
var GetSprints string = `SELECT id, name FROM sprints WHERE project_id=$1 AND name ILIKE $2`

var CountSprints string = `SELECT COUNT(*) FROM sprints WHERE project_id=$1 AND name ILIKE $2`
